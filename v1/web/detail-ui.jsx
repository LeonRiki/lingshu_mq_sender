...
function UpdateDialog({ data }) {
  ...
  const modalTitle = check?.updateAvailable
    ...
    : '在线更新';
  return <Modal open={data.open} centered className="update-dialog-modal" title={modalTitle} width={760} onCancel={() => emitListToolbar('close-update-dialog')} footer={null} destroyOnHidden>
